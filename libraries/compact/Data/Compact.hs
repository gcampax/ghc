...
-- | 'getCompact': retrieve the object that was stored in a Compact
getCompact :: Compact a -> a
getCompact (Compact _ obj) = obj

-- | 'inCompact': check if the second argument is inside the Compact
inCompact :: Compact a -> b -> Bool
inCompact = compactContains

-- | 'isCompact': check if the argument is any is in any Compact
isCompact :: a -> Bool
